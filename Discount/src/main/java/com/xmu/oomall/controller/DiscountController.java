...
//                         @Order @RequestParam(defaultValue = "desc") String order);
    ...
    public Object update(@PathVariable Integer id,@RequestBody Coupon coupon);
    ...
    public Object delete(@PathVariable Integer id, @RequestBody Coupon coupon);
    ...
    @GetMapping("")
    public default Object list(@RequestParam(defaultValue = "1") Integer page,
                               @RequestParam(defaultValue = "10") Integer limit,
                               @RequestParam(defaultValue = "add_time") String sort,
                               @RequestParam(defaultValue = "desc") String order) {
    }
